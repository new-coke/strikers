...
#define VI_TVMODE_GCA_INT VI_TVMODE(VI_GCA, VI_INTERLACE)
#define VI_TVMODE_GCA_DS VI_TVMODE(VI_GCA, VI_NON_INTERLACE)
#define VI_TVMODE_GCA_PROG VI_TVMODE(VI_GCA, VI_PROGRESSIVE)
