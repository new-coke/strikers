...
// clang-format off
void PSMTXMultVec(const register Mtx m, const register Vec* src, register Vec* dst)
{
...
// clang-format off
void PSMTXMultVecArraySR(const register Mtx m, const register Vec* srcBase, register Vec* dstBase, register u32 count)
{
    // PORT: paired-single kernel replaced by its portable twin.
