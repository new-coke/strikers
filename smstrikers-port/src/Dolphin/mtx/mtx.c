 ...
 */
void PSMTXConcat(const register Mtx a, const register Mtx b, register Mtx ab)
{
    // PORT: paired-single kernel replaced by its portable twin.
    C_MTXConcat(a, b, ab);
}
...
// clang-format off
u32 PSMTXInverse(const register Mtx src, register Mtx inv)
{
    // PORT: paired-single kernel replaced by its portable twin.
 ...
 */
u32 PSMTXInvXpose(const register Mtx src, register Mtx invX)
{
    // PORT: paired-single kernel replaced by its portable twin.
...
// PORT: removed __PSMTXRotAxisRadInternal, paired-single helper, now unused.
...
// clang-format off
void PSMTXTransApply(const register Mtx src, register Mtx dst, register f32 xT, register f32 yT, register f32 zT)
{
    // PORT: paired-single kernel replaced by its portable twin.
