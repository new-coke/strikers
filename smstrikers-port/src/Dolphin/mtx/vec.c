...
// clang-format off
void PSVECAdd(const register Vec* a, const register Vec* b, register Vec* ab)
{
...
// clang-format off
void PSVECSubtract(const register Vec* a, const register Vec* b, register Vec* a_b)
{
    // PORT: paired-single kernel replaced by its portable twin.
...
// clang-format off
f32 PSVECDotProduct(const register Vec* a, const register Vec* b)
{
    // PORT: paired-single kernel replaced by its portable twin.
...
// clang-format off
void PSVECCrossProduct(const register Vec* a, const register Vec* b, register Vec* axb)
{
    // PORT: paired-single kernel replaced by its portable twin.
