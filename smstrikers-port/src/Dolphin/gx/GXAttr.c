...
static inline void SETVCDATTR(GXAttr Attr, GXAttrType Type)
{
    ...
    {
    case GX_VA_PNMTXIDX:
        SET_REG_FIELD(212, __GXData->vcdLo, 1, 0, Type);
        break;
    case GX_VA_TEX0MTXIDX:
        SET_REG_FIELD(213, __GXData->vcdLo, 1, 1, Type);
        break;
    case GX_VA_TEX1MTXIDX:
        SET_REG_FIELD(214, __GXData->vcdLo, 1, 2, Type);
        break;
    case GX_VA_TEX2MTXIDX:
        SET_REG_FIELD(215, __GXData->vcdLo, 1, 3, Type);
        break;
    case GX_VA_TEX3MTXIDX:
        SET_REG_FIELD(216, __GXData->vcdLo, 1, 4, Type);
        break;
    case GX_VA_TEX4MTXIDX:
        SET_REG_FIELD(217, __GXData->vcdLo, 1, 5, Type);
        break;
    case GX_VA_TEX5MTXIDX:
        SET_REG_FIELD(218, __GXData->vcdLo, 1, 6, Type);
        break;
    case GX_VA_TEX6MTXIDX:
        SET_REG_FIELD(219, __GXData->vcdLo, 1, 7, Type);
        break;
    case GX_VA_TEX7MTXIDX:
        SET_REG_FIELD(220, __GXData->vcdLo, 1, 8, Type);
        break;
    case GX_VA_POS:
        SET_REG_FIELD(221, __GXData->vcdLo, 2, 9, Type);
        break;
    case GX_VA_NRM:
        if (Type != GX_NONE)
        {
    ...
    case GX_VA_NBT:
        ...
        break;
    case GX_VA_CLR0:
        SET_REG_FIELD(246, __GXData->vcdLo, 2, 13, Type);
        break;
    case GX_VA_CLR1:
        SET_REG_FIELD(247, __GXData->vcdLo, 2, 15, Type);
        break;
    case GX_VA_TEX0:
        SET_REG_FIELD(248, __GXData->vcdHi, 2, 0, Type);
        break;
    case GX_VA_TEX1:
        SET_REG_FIELD(249, __GXData->vcdHi, 2, 2, Type);
        break;
    case GX_VA_TEX2:
        SET_REG_FIELD(250, __GXData->vcdHi, 2, 4, Type);
        break;
    case GX_VA_TEX3:
        SET_REG_FIELD(251, __GXData->vcdHi, 2, 6, Type);
        break;
    case GX_VA_TEX4:
        SET_REG_FIELD(252, __GXData->vcdHi, 2, 8, Type);
        break;
    case GX_VA_TEX5:
        SET_REG_FIELD(253, __GXData->vcdHi, 2, 10, Type);
        break;
    case GX_VA_TEX6:
        SET_REG_FIELD(254, __GXData->vcdHi, 2, 12, Type);
        break;
    case GX_VA_TEX7:
        SET_REG_FIELD(255, __GXData->vcdHi, 2, 14, Type);
        break;
    }
}
...
void GXSetTexCoordGen2(GXTexCoordID dst_coord, GXTexGenType func, GXTexGenSrc src_param, u32 mtx, GXBool normalize, u32 pt_texmtx)
{
    ...
    {
    case GX_TEXCOORD0:
        SET_REG_FIELD(1147, __GXData->matIdxA, 6, 6, mtx);
        break;
    case GX_TEXCOORD1:
        SET_REG_FIELD(1148, __GXData->matIdxA, 6, 12, mtx);
        break;
    case GX_TEXCOORD2:
        SET_REG_FIELD(1149, __GXData->matIdxA, 6, 18, mtx);
        break;
    case GX_TEXCOORD3:
        SET_REG_FIELD(1150, __GXData->matIdxA, 6, 24, mtx);
        break;
    case GX_TEXCOORD4:
        SET_REG_FIELD(1151, __GXData->matIdxB, 6, 0, mtx);
        break;
    case GX_TEXCOORD5:
        SET_REG_FIELD(1152, __GXData->matIdxB, 6, 6, mtx);
        break;
    case GX_TEXCOORD6:
        SET_REG_FIELD(1153, __GXData->matIdxB, 6, 12, mtx);
        break;
    default:
        SET_REG_FIELD(1154, __GXData->matIdxB, 6, 18, mtx);
        break;
    }
