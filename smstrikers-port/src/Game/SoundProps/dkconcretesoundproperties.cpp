...
/**
 * Offset/Address/Size: 0xF4 | 0x801B0924 | size: 0x10
 */
void DKCONCRETESoundPropAccessor::ResetSoundPropTable()
{
    m_pTable = DKCONCRETESoundProperties;
}

/**
 * Offset/Address/Size: 0xD8 | 0x801B0908 | size: 0x1C
 */
bool DKCONCRETESoundPropAccessor::IsUsingOrigTable() const
{
    return (m_pTable == DKCONCRETESoundProperties) ? true : false;
}

/**
 * Offset/Address/Size: 0xCC | 0x801B08FC | size: 0xC
 */
const char* DKCONCRETESoundPropAccessor::GetHTMLFileName() const
{
    return "dkconcretesoundproperties.htm";
}

/**
 * Offset/Address/Size: 0xC0 | 0x801B08F0 | size: 0xC
 */
const char* DKCONCRETESoundPropAccessor::GetSoundPropTableName() const
{
    return "DKCONCRETE";
}

/**
 * Offset/Address/Size: 0xB8 | 0x801B08E8 | size: 0x8
 */
u32 DKCONCRETESoundPropAccessor::GetNumSFX() const
{
    return sizeof(DKCONCRETESoundProperties) / sizeof(SoundProperties);
}

/**
 * Offset/Address/Size: 0xB0 | 0x801B08E0 | size: 0x8
 */
SoundProperties* DKCONCRETESoundPropAccessor::GetSoundPropTable()
{
    return m_pTable;
}

/**
 * Offset/Address/Size: 0x50 | 0x801B0880 | size: 0x60
 */
SoundProperties* DKCONCRETESoundPropAccessor::GetSoundProperty(unsigned int index) const
{
    u32 n = GetNumSFX();
    if (index >= n)
        return NULL;
