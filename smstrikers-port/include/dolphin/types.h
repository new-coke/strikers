...
#if 0 // PORT: BOOL is `int` on the console; `bool` would resize it to 1 byte.
#include <stdbool.h>
typedef bool BOOL;
#ifndef FALSE
#define FALSE false
...
// PORT: clang defines no __GNUC__ when targeting windows-msvc, and the _MSC_VER branch below defines this to NOTHING.
...
#else
// PORT: every compiler that is not MWCC expands this to nothing.
