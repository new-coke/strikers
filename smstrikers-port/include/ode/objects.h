...
extern "C"
{
    ...
    const dReal* dBodyGetRotation(dBodyID b); /* ptr to 4x3 rot matrix */
    ...
    dJointID dJointCreateContact(dWorldID w, dJointGroupID group, const dContact* c);
    ...
    int dJointGetType(dJointID joint);
